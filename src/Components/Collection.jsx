...
function Collection() {
  ...
  return (
    <div className="flex flex-col px-10 py-8 bg-[#fffdf3]">
    <img src="/collection/9.png" alt="Collection" className="absolute -left-4  h-full w-full mt-40 z-0" />
    <img src="/collection/10.png" alt="Collection" className="absolute -left-4  h-full w-full mt-52 z-0" />
      {/* Heading Section */}
      <div className="text-start flex flex-col gap-3">
        <h1 className="text-4xl font-bold mb-4">Grow your collection</h1>
      ...
      <div className="flex mt-16">
          ...
          <div className="space-y-4">
            {menuItems.map((item, index) => (
              <div
                ...
                className={`flex items-center space-x-2 w-80 p-3 rounded-lg cursor-pointer ${
        ...
        <div className="w-3/4 flex justify-center relative">
          ...
          <div className="relative pr-40">
            <img
              src="/collection/2.png" // Add your image URL here
              alt="Shoe Collection"
              className="rounded-lg w-full h-full "
            />
            {/* Second Overlay Image */}
            <div className="absolute bottom-0 right-0 translate-x-32 translate-y-52 ">
              <img
                src="/collection/3.png" // Add your image URL here
                alt="Detail"
